...
<html>
    <head>
       ...
       <style>
            *{font-family: "微软雅黑";}
            .center{width: 40%;margin: 0 auto;margin-top: 150px;height: 200px;background:#D64E42 ;padding-top: 30px;}
            .center_title{text-align: center;font-size:20px;color:white;}
            .center_data{height: 60px;line-height: 60px;text-align: center;color:white;}
    ...
    <body>
        <div class="center">
            <div  class="center_title">温馨提示：error</div>
